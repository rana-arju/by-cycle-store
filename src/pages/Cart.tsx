...
function Cart() {
  return (
    ...
    >
      <div
        className="font-sans max-w-4xl max-md:max-w-xl mx-auto  container"
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-8">
          <div className="md:col-span-2 space-y-4">
            <div
              className="flex gap-4 bg-white px-4 py-6 rounded-md shadow-[0_2px_12px_-3px_rgba(61,63,68,0.3)] justify-between"
          ...
          >
            <ul className="text-gray-800 space-y-4 flex flex-col justify-center gap-[10px]">
              <li className="flex justify-between items-center">
                <p>Subtotal </p> <p className="ml-auto font-bold">$200.00</p>
              </li>
              <li className="flex justify-between items-center">
              ...
              <li className="flex justify-between items-center">
                Total <span className="ml-auto font-bold">$206.00</span>
              </li>
            </ul>
